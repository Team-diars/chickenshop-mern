  ...
  return (
    <Box maxW="full">
      <Box
        ...
        backgroundImage={
          appname === "Harike"
            ? //https://media.discordapp.net/attachments/877385598627905579/890098348927881226/como-abrir-una-polleria.png
              "url(./images-website/hero-2.jpg)"
            : "url(./images-website/hero-1.jpg)"
        }
      ...
      {/* <Container maxWidth="container.xl">
        ...
        <Flex w="full" alignItems="center" flexWrap="wrap" my="10">
          {categories.map((item, idx) => (
            <CategoryCard key={idx} product={item} />
          ))}
        </Flex>
      </Container> */}
      {/* <Container maxWidth="container.xl">
